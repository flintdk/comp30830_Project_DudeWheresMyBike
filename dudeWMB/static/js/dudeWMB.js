...
async function initMap() {
    ...
    if (document.getElementById("mapContentDescription") != null) {
        ...
        if (varGlobActiveMode = MODE_AVAILABLE_BIKES) {
            ...
            modeDesc = "Available Spaces";
        }
        let timeDesc = "";
        if (varGlobPredictedDateTime != null) {
            timeDesc = varGlobPredictedDateTime;
        }
        else {
            timeDesc = new Date().toLocaleString();
        }
        document.getElementById("mapContentDescription").innerHTML
            = "Showing " + modeDesc + " for " + timeDesc;
    } 
    createMarkers();
}
